        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              // 3. THIS IS WHAT WAS MISSING: The InkWell wrapper!
              return InkWell(
                onTap: () {
                  // Navigate based on the type
                  if (isExhibit) {
                    context.push('/sub-event-details/exhibit');
                  } else {
                    context.push('/sub-event-details/sub');
                  }
                },
                borderRadius: BorderRadius.circular(12.r), // Keeps the click ripple inside the corners
                child: Container(
