...
import '../../../core/utils/points_sheet.dart';
...
class HomeScreen extends StatelessWidget {
    ...
    return Scaffold(
          ...
          Stack(
            ...
            children: [
              IconButton(
                ...
                onPressed: () => debugPrint("Notifications Tapped"), // Changed to debugPrint
              ),
              Positioned(
                top: 10.h,
                right: 10.w,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // 1. NEW: MY POINTS CARD - FIX: Passed context here!
  ...
  // FIX: Added BuildContext context here!
  Widget _buildPointsCard(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.black.withValues(alpha: 0.04), // Fixed opacity warning
            blurRadius: 10,
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            right: 0,
            child: InkWell(
              onTap: () => PointsSheet.show(context), // Now context is perfectly valid!
  ...
  Widget _buildAnnouncementCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: Colors.grey.shade200),
        boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.03), blurRadius: 5)], // Fixed opacity warning
      ),
      child: Row(
        children: [
